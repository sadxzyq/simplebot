...
let handler = async (m, { conn, isRowner}) => {
  ...
  let speed = neww - old
  let zyko = 'https://telegra.ph/file/12ef4b5b06b3b906ffb93.jpg'
  let runtt = `*s ᴘ ᴇ ᴇ ᴅ*
...
let fliveLoc22 = {
            ...
            message: { "liveLocationMessage": { "title": gcname,"h": bottime, 'jpegThumbnail': fs.readFileSync('./media/speed.jpg')}}
           }
await conn.send2ButtonDoc(m.chat, runtt, botdate, '𝐌𝐞𝐧𝐮', '.Menu', '𝐃𝐚𝐬𝐛𝗼𝐚𝐫𝐝', '.dashboard', fliveLoc22, {
			contextInfo: {
